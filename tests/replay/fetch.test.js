...
const JSON_ERROR_REGEX =
  /((not |In)valid JSON|^JSON Parse error|^Failed to parse JSON|^Unexpected (token|character) .* in JSON|^JSON\.parse: unexpected character|^The string did not match the expected pattern\.$|invalid character \(in JSON\.parse\))|^unexpected token: '.'$|^expected value at line |^Invalid value\.$|^Malformed JSON string$/
